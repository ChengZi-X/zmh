...
import com.zmh.zz.zmh.activity.Ac_Add_Address;
import com.zmh.zz.zmh.activity.Ac_Add_Bank_Card;
...
public class FragmentTask extends BaseFragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.sign:
                startActivity(new Intent(getActivity(), Ac_Check_Calendar.class));
                break;
            ...
            case R.id.add_bank_card:
                startActivity(new Intent(getActivity(), Ac_Add_Bank_Card.class));
                break;
            case R.id.add_address:
                startActivity(new Intent(getActivity(), Ac_Add_Address.class));
                break;
        }
    }
}
