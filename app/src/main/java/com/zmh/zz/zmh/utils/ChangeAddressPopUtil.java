 ...
 * 省市区选择
 */
public class ChangeAddressPopUtil extends PopupWindow implements View.OnClickListener {
    ...
    private String strProvince = "河南";
    private String strCity = "郑州";
    private String strArea = "金水区";
...
//			dismiss();
    ...
    public void initCitys(String[] citys) {
        if (citys != null) {
            ...
            String[] city = mCitisDatasMap.get("河南");
            arrCitys.clear();
    ...
    public void initAreas(String[] areas) {
        if (areas != null) {
            ...
            String[] area = mAreaDatasMap.get("郑州");
            arrAreas.clear();
