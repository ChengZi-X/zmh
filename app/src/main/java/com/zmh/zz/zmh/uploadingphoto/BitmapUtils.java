...
public class BitmapUtils {
    ...
    private static String saveMyBitmap(String filename, Bitmap bit) {
        String baseDir = Environment.getExternalStorageDirectory().getAbsolutePath() + "/zmh/";
        ...
        try {
            ...
            bit.compress(Bitmap.CompressFormat.PNG, 100, fOut);//存100张
            fOut.flush();
            fOut.close();
    ...
    public static void deleteCacheFile() {
        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/zmh/");
