...
public class EssentialInformation extends BaseActivity implements View.OnClickListener {
    ...
    protected void onClickRight() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(EssentialInformation.this);
        dialog.setTitle("提示");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.validity_of_a_certificate:
                DatePickerDialog dateDlg = new DatePickerDialog(EssentialInformation.this, date,
