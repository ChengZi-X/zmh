...
import com.zmh.zz.zmh.activity.Ac_Top_Up;

import java.util.List;


public class MyAdapter_Top_Up extends BaseAdapter {
    private List<BankcardBean> mBankcards;
    private Ac_Top_Up mContext;

    public MyAdapter_Top_Up(List<BankcardBean> mBankcards, Ac_Top_Up context) {
