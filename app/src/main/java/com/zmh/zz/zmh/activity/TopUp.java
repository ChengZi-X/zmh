...
import com.zmh.zz.zmh.selectbankcard.MyAdapterTopUp;
...
public class TopUp extends AppCompatActivity implements View.OnClickListener, OnBankcardSlected {
    ...
    private void showPopWindow() {
        ...
        MyAdapterTopUp adapter = new MyAdapterTopUp(mList, TopUp.this);
