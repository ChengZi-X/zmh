...
import com.zmh.zz.zmh.activity.Ac_Withdraw;

import java.util.List;


public class MyAdapter_Witdraw extends BaseAdapter {
    private List<BankcardBean> mBankcards;
    private Ac_Withdraw mContext;

    public MyAdapter_Witdraw(List<BankcardBean> mBankcards, Ac_Withdraw context) {
